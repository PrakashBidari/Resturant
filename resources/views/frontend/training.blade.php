...
@section('main')
    <section class="home-slider owl-carousel">
        ...
        <div class="slider-item" style="background-image: url({{ asset('frontend/images/training1-min.jpeg') }});"
            ...
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center">
                    ...
                    <div class="col-md-7 col-sm-12 text-center ftco-animate">
                        <h1 class="mb-3 mt-5 bread">Training</h1>
                        <p class="breadcrumbs"><span class="mr-2"><a href="{{route ('home')}}">Home</a></span> <span>Training</span>
                        </p>
                    </div>
    ...
    <section class="ftco-section">
        <div class="container">
            <div class="row d-flex">
                ...
                @if ($trainings->count())
                    @foreach ($trainings as $blog)
                        <div class="col-md-4 d-flex ftco-animate">
                            <div class="blog-entry align-self-stretch">
                                @if ($latestImage = $blog->image)
                                    <a href="{{ route('training.detail', $blog) }}" class="block-20"
                                        style="background-image: url({{ Storage::url($latestImage->url . '/' . $latestImage->saved_name) }})">
                                    </a>
                                @endif
                                <div class="text py-4 d-block">
                                    <div class="meta">
                                        <div><a href="{{ route('training.detail', $blog) }}">{{ $blog->created_at->format('M d, Y') }}</a></div>
                                        <div><a href="{{ route('training.detail', $blog) }}">{{ $blog->author }}</a></div>
                                        {{-- <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div> --}}
                                    </div>
                                    <h3 class="heading mt-2"><a href="{{ route('training.detail', $blog) }}">
            ...
            <div class="row mt-5">
                <div class="col text-center">
                    <div class="block-27">
                        {{ $trainings->links('frontend.pagination.index') }}
                        {{-- <ul>
                            <li><a href="#">&lt;</a></li>
